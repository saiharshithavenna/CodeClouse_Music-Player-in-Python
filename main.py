...
rootpath="C:\\Users\Honey Harshi\Music\orange"
pattern="*.mp3"
...
listBox=tk.Listbox(canvas,fg="red",bg="black",width=100,font=('Artis ttnorm',14))
listBox.pack(padx=10,pady=14)

label=tk.Label(canvas,text='',bg='black',fg='yellow',font=('Artis ttnorm',14))
label.pack(pady=14)
